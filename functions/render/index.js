...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-6a6bb02f.js",
      css: ["/./_app/assets/start-230d6437.css"],
      js: ["/./_app/start-6a6bb02f.js", "/./_app/chunks/vendor-2f003f75.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = {"src/routes/__layout.svelte": {"entry": "/./_app/pages/__layout.svelte-825193ea.js", "css": ["/./_app/assets/pages/__layout.svelte-61d65614.css"], "js": ["/./_app/pages/__layout.svelte-825193ea.js", "/./_app/chunks/vendor-2f003f75.js"], "styles": null}, ".svelte-kit/build/components/error.svelte": {"entry": "/./_app/error.svelte-60e3347c.js", "css": [], "js": ["/./_app/error.svelte-60e3347c.js", "/./_app/chunks/vendor-2f003f75.js"], "styles": null}, "src/routes/index.svelte": {"entry": "/./_app/pages/index.svelte-df24f74c.js", "css": [], "js": ["/./_app/pages/index.svelte-df24f74c.js", "/./_app/chunks/vendor-2f003f75.js", "/./_app/chunks/index-d607c0e4.js"], "styles": null}, "src/routes/articles/index.svelte": {"entry": "/./_app/pages/articles/index.svelte-39f5e725.js", "css": [], "js": ["/./_app/pages/articles/index.svelte-39f5e725.js", "/./_app/chunks/vendor-2f003f75.js"], "styles": null}, "src/routes/articles/testing.mdx": {"entry": "/./_app/pages/articles/testing.mdx-60541d26.js", "css": [], "js": ["/./_app/pages/articles/testing.mdx-60541d26.js", "/./_app/chunks/vendor-2f003f75.js", "/./_app/chunks/index-d607c0e4.js"], "styles": null}, "src/routes/about.svelte": {"entry": "/./_app/pages/about.svelte-b81ec215.js", "css": ["/./_app/assets/pages/about.svelte-7c88e487.css"], "js": ["/./_app/pages/about.svelte-b81ec215.js", "/./_app/chunks/vendor-2f003f75.js"], "styles": null}};
...
<div class="${"relative bg-gray-50"}"><main class="${"lg:relative"}"><div class="${"mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left"}"><div class="${"px-4 lg:w-1/2 sm:px-8 xl:pr-16"}">${heroTitle ? `<h1 class="${"text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl"}">${escape2(heroTitle)}</h1>` : ``}
        ...
        ${description ? `<p class="${"mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl"}">${escape2(description)}</p>` : ``}
          ...
          <div class="${"rounded-md shadow"}"><div class="${"mt-10 sm:flex sm:justify-center lg:justify-start"}"><a href="${"/"}" class="${"w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"}">Schedule a free consultancy call
            </a></div></div></div></div>
    <div class="${"relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full"}"><img class="${"absolute inset-0 w-full h-full object-cover"}" src="${"https://images.unsplash.com/photo-1520333789090-1afc82db536a?ixlib=rb-1.2.1&ixqx=CAbeOHCG03&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2102&q=80"}" alt="${""}"></div></main></div>`;
});
  ...
  return `<div class="${"py-8 px-4 sm:px-6 md:py-8 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16 dark:border-gray-700"}"><div class="${"relative text-lg font-medium text-gray-500 md:flex-grow"}"><svg class="${"absolute top-0 left-0 transform -translate-x-3 -translate-y-2 h-8 w-8 text-blue-600"}" fill="${"currentColor"}" viewBox="${"0 0 32 32"}"><path d="${"M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z"}"></path></svg></div>
    <blockquote class="${"mt-6 md:flex-grow md:flex md:flex-col"}"><div class="${"text-2xl leading-9 font-medium text-gray-900 dark:text-gray-200"}">${escape2(testimonial.quoteTitle)}</div>
        ...
        <footer class="${"mt-8"}"><div class="${"flex"}"><div class="${"flex-shrink-0 inline-flex rounded-full border-2 border-white dark:border-gray-500"}"><img${add_attribute("src", testimonial.authorAvatarUrl, 0)} alt="${"me"}" width="${"150"}" height="${"150"}" class="${"object-cover object-top rounded-full"}"></div>
                <div class="${"ml-4"}"><div class="${"text-base font-medium text-gray-500 dark:text-gray-300"}">${escape2(testimonial.authorName)} - ${escape2(testimonial.companyName)}</div>
                    <div class="${"text-base font-medium text-blue-500"}">${escape2(testimonial.authorLocation)} YOLO</div></div></div></footer></blockquote></div>`;
});
var Testimonials = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div>${each(testimonials, (testimonial) => `<div class="${"p-2 md:px-8"}">${validate_component(Testimonial, "Testimonial").$$render($$result, {testimonial}, {}, {})}
        </div>`)}</div>`;
});
...
var LogoCloud = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div>Logo Cloud will be here
</div>`;
});
...
<section>${validate_component(Hero, "Hero").$$render($$result, {
	...
	<section>${validate_component(Stats, "Stats").$$render($$result, {}, {}, {})}</section>
	<section>${validate_component(LogoCloud, "LogoCloud").$$render($$result, {}, {}, {})}</section>
	<section>${validate_component(Testimonials, "Testimonials").$$render($$result, {testimonials, "}": true}, {}, {})}</section></section>`;
});
